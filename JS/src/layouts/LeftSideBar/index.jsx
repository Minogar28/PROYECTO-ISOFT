...
const LeftSideBarMenu = () => {
  ...
  return <LeftSideBarWrapper settings={settings} className="app-menu-do-not-remove">
...
const LeftSideBar = () => {
  ...
  return settings.sidenav.mode == "default" ? <LeftSideBarMenu /> : <Drawer open={showMobileMenu} onClose={hideSideNavMobile}>
      <LeftSideBarMenu />
    </Drawer>;
};
